...
import com.example.pertemuan4_actionbar.databinding.HotelDatabaseBinding;
...
public class HotelMain extends AppCompatActivity {
    ...
    private HotelDatabaseBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = HotelDatabaseBinding.inflate(getLayoutInflater());
    ...
    private void insertData() {
        binding.btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rec != null) {
                    Toast.makeText(HotelMain.this, "Data  Inserted", Toast.LENGTH_SHORT).show(); binding.edtname.setText("");

                    binding.edtimage.setImageResource(R.mipmap.ic_launcher);
                    binding.edtstar.setText("");
                    binding.edtprice.setText("");
                } else {
                    Toast.makeText(HotelMain.this, "Something  Wrong", Toast.LENGTH_SHORT).show();
                }
            }
        });
        //for view display
        binding.btnDisplay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(HotelMain.this, DisplayData.class));
            }
        });
        ...
        binding.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (recedit != -1) {
                    Toast.makeText(HotelMain.this, "Update  Succesfully", Toast.LENGTH_SHORT).show();
                    ...
                    Intent a = new Intent(HotelMain.this, DisplayData.class);
                    startActivity(a);
                }
            }
        });
